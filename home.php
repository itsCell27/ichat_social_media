    ...
    <header class="navbar">
        ...
        <div class="middle_icons">
            <div class="middle_icons_wrap">
                ...
                <div class="middle_icon_wrap" onclick="window.location.href='view_saved_post.php'">
                            ...
                            echo "
                                        <div class='post_story_user'>
                                            <div class='story_img_user_containner $borderClass'>
                                                <img class='post_story_user_img profile-picture $borderClass' src='" . $user_data
                                                    ['profile_picture'] . "' 

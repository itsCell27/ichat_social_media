...
<body>
    ...
    <main>
       ...
       <form method="POST" action="forgot_password_new.php" class="login_page">

                <h1 class="login_title">Forgot password</h1>

                <p class="forgot_text">Don't worry. Fill in your email and we'll send you a link to reset your password.</p>

                <input name="email" id="email" class="email input_login" type="email" required  placeholder="email" autocapitalize="off">
                
                <button type="submit" class="forgot_btn btn">Send</button>
